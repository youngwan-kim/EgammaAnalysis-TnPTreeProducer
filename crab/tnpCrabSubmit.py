...
#
submitVersion = "ElectronTnP_HNTypeI_UL" # add some date here
doL1matching  = False
...
mainOutputDir = '/store/user/youngwan/%s' % submitVersion
...
def getLumiMask(era):
  ...
  if   era=='2016':   return '/afs/cern.ch/user/h/helee/json/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt'
  elif era=='2017':   return '/afs/cern.ch/user/h/helee/json/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON.txt'
  elif era=='2018':   return '/afs/cern.ch/user/h/helee/json/Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON.txt'
  elif era=='UL2016preVFP':  return '/data9/Users/youngwan/work/HNTypeI_TnP/CMSSW_10_6_13/src/EgammaAnalysis/TnPTreeProducer/crab/json/2016preVFP.json'
  elif era=='UL2016postVFP':  return '/data9/Users/youngwan/work/HNTypeI_TnP/CMSSW_10_6_13/src/EgammaAnalysis/TnPTreeProducer/crab/json/2016postVFP.json'
...
#  submitWrapper('DY_NNLO',  '/DYJetsToEE_M-50_massWgtFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/RunIISummer20UL16MiniAOD-106X_mcRun2_asymptotic_v13-v2/MINIAODSIM', era)
  ...
  #submitWrapper('DY_LO_ext1', '/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3_ext1-v2/MINIAODSIM', era)
  #submitWrapper('DY_LO_ext2', '/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3_ext2-v2/MINIAODSIM', era)
  ...
  era       = '2017'
  #submitWrapper('Run2017B_v0', '/SingleElectron/Run2017B-31Mar2018-v1/MINIAOD', era)
  #submitWrapper('Run2017C_v0', '/SingleElectron/Run2017C-31Mar2018-v1/MINIAOD', era)
  #submitWrapper('Run2017D_v0', '/SingleElectron/Run2017D-31Mar2018-v1/MINIAOD', era)
  #submitWrapper('Run2017E_v0', '/SingleElectron/Run2017E-31Mar2018-v1/MINIAOD', era)
  #submitWrapper('Run2017F_v0', '/SingleElectron/Run2017F-31Mar2018-v1/MINIAOD', era)

  #submitWrapper('DY1_LO_v0',     '/DY1JetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM', era)
  #submitWrapper('DY1_LO_ext_v0', '/DY1JetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_v3_94X_mc2017_realistic_v14_ext1-v2/MINIAODSIM', era)
  #submitWrapper('DY_NLO_v0',     '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM',  era)
  #submitWrapper('DY_NLO_ext_v0', '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14_ext1-v1/MINIAODSIM', era)
