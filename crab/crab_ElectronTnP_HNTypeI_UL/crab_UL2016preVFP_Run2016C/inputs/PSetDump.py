...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/data/Run2016B/SingleElectron/MINIAOD/21Feb2020_ver2_UL2016_HIPM-v1/00000/00A5D384-5256-7940-BAFB-C2C549342582.root')
)
...
process.leptonMvaGhent = cms.EDProducer("LeptonMvaProducer",
    PFIsoAll = cms.InputTag("isoForEleSummer16","PFIsoAll"),
    ...
    miniIsoAll = cms.InputTag("isoForEleSpring15","miniIsoAll"),
    miniIsoChg = cms.InputTag("isoForEleSpring15","miniIsoChg"),
    ...
    weightFile = cms.FileInPath('EgammaAnalysis/TnPTreeProducer/data/el_tZqTTV16_BDTG.weights.xml')
)
...
process.leptonMvaTOP = cms.EDProducer("LeptonMvaProducer",
    ...
    ptRatio = cms.InputTag("ptRatioRelForEle","ptRatio"),
    ptRel = cms.InputTag("ptRatioRelForEle","ptRel"),
    weightFile = cms.FileInPath('EgammaAnalysis/TnPTreeProducer/data/el_TOP16_BDTG.weights.xml')
)
...
process.leptonMvaTTH = cms.EDProducer("LeptonMvaProducer",
    ...
    ptRatio = cms.InputTag("ptRatioRelForEle","ptRatio"),
    ptRel = cms.InputTag("ptRatioRelForEle","ptRel"),
    weightFile = cms.FileInPath('EgammaAnalysis/TnPTreeProducer/data/el_ttH16_BDTG.weights.xml')
)
...
process.passHltDoubleEle33CaloIdLMWSeedLegL1match = cms.EDProducer("PatElectronTriggerCandProducer",
    ...
    dR = cms.double(0.3),
    filterNames = cms.vstring('hltEG33CaloIdLMWPMS2Filter'),
...
process.passHltEle27WPTightGsf = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.3),
...
process.pileupReweightingProducer = cms.EDProducer("PileupWeightProducer",
    PileupData = cms.vdouble(
        239000.0, 838000.0, 2310000.0, 3120000.0, 4480000.0, 
        ...
        1520.0, 1320.0, 1140.0, 983, 839, 
        711, 598, 500, 415, 342, 
        280, 228, 184, 148, 118, 
        93.3, 73.3, 57.3, 44.4, 34.2, 
        26.2, 19.9, 15, 11.3, 8.4, 
...
process.probeElePassHLT = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.3),
    filterNames = cms.vstring('hltEle27erWPTightGsfTrackIsoFilter'),
    inputs = cms.InputTag("probeEle"),
    isAND = cms.bool(False),
    objects = cms.InputTag("slimmedPatTrigger")
)
...
process.hltFilter = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_Ele27_eta2p1_WPTight_Gsf_v*'),
...
process.tnpEleTrig = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    flags = cms.PSet(
        ...
        passHltEle27WPTightGsf = cms.InputTag("passHltEle27WPTightGsf"),
        passingCutBasedLoose80X = cms.InputTag("probeEleCutBasedLoose80X"),
        passingCutBasedLoose94X = cms.InputTag("probeEleCutBasedLoose94X"),
        passingCutBasedLoose94XV2 = cms.InputTag("probeEleCutBasedLoose94XV2"),
        passingCutBasedLoose94XV2GsfEleConversionVetoCut = cms.InputTag("probeEleCutBasedLoose94XV2GsfEleConversionVetoCut"),
...
process.hlt_sequence = cms.Sequence(process.hltFilter+process.passHltDoubleEle33CaloIdLMWUnsLeg+process.passHltEle23Ele12CaloIdLTrackIdLIsoVLLeg2+process.passHltEle27WPTightGsf+process.passHltDoubleEle33CaloIdLMWSeedLegL1match+process.passHltEle23Ele12CaloIdLTrackIdLIsoVLLeg1L1match)
