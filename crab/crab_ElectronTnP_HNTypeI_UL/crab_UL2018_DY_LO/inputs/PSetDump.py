...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/RunIISummer19UL18MiniAOD/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v11_L1v1-v2/70000/EA2F219D-8534-7B4D-AF83-5D91AF448EC6.root')
)
...
process.leptonMvaTOP = cms.EDProducer("LeptonMvaProducer",
    ...
    ptRatio = cms.InputTag("ptRatioRelForEle","ptRatio"),
    ptRel = cms.InputTag("ptRatioRelForEle","ptRel"),
    weightFile = cms.FileInPath('EgammaAnalysis/TnPTreeProducer/data/el_TOP18_BDTG.weights.xml')
)
...
process.passHltEle32WPTightGsf = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.3),
    filterNames = cms.vstring('hltEle32WPTightGsfTrackIsoFilter'),
    inputs = cms.InputTag("probeEle"),
    isAND = cms.bool(False),
    objects = cms.InputTag("slimmedPatTrigger")
)
...
process.pileupReweightingProducer = cms.EDProducer("PileupWeightProducer",
    PileupData = cms.vdouble(
        272000.0, 956000.0, 3040000.0, 6830000.0, 12200000.0, 
        18900000.0, 28000000.0, 40800000.0, 57700000.0, 80300000.0, 
        113000000.0, 158000000.0, 220000000.0, 302000000.0, 404000000.0, 
        528000000.0, 676000000.0, 846000000.0, 1030000000.0, 1230000000.0, 
        1410000000.0, 1580000000.0, 1730000000.0, 1840000000.0, 1920000000.0, 
        1990000000.0, 2050000000.0, 2110000000.0, 2160000000.0, 2210000000.0, 
        2260000000.0, 2310000000.0, 2340000000.0, 2360000000.0, 2370000000.0, 
        2360000000.0, 2330000000.0, 2260000000.0, 2180000000.0, 2060000000.0, 
        1910000000.0, 1740000000.0, 1560000000.0, 1360000000.0, 1170000000.0, 
        977000000.0, 801000000.0, 642000000.0, 505000000.0, 389000000.0, 
        295000000.0, 220000000.0, 162000000.0, 118000000.0, 84800000.0, 
        60600000.0, 43000000.0, 30300000.0, 21300000.0, 14800000.0, 
        10200000.0, 7020000.0, 4770000.0, 3200000.0, 2130000.0, 
        1400000.0, 905000.0, 579000.0, 366000.0, 229000.0, 
        142000.0, 86600.0, 52400.0, 31400.0, 18600.0, 
        11000.0, 6370.0, 3670.0, 2090.0, 1180.0, 
        656, 361, 196, 105, 55.3, 
        28.7, 14.7, 7.41, 3.67, 1.79, 
        0.858, 0.404, 0.187, 0.0852, 0.0381, 
        0.0167, 0.00722, 0.00306, 0.00128, 0.000527
    ),
...
process.tnpEleTrig = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    flags = cms.PSet(
        ...
        passHltEle32WPTightGsf = cms.InputTag("passHltEle32WPTightGsf"),
        passingCutBasedLoose80X = cms.InputTag("probeEleCutBasedLoose80X"),
        passingCutBasedLoose94X = cms.InputTag("probeEleCutBasedLoose94X"),
        passingCutBasedLoose94XV2 = cms.InputTag("probeEleCutBasedLoose94XV2"),
        passingCutBasedLoose94XV2GsfEleConversionVetoCut = cms.InputTag("probeEleCutBasedLoose94XV2GsfEleConversionVetoCut"),
...
process.hlt_sequence = cms.Sequence(process.hltFilter+process.passHltEle23Ele12CaloIdLTrackIdLIsoVLLeg2+process.passHltDoubleEle33CaloIdLMWUnsLeg+process.passHltEle32WPTightGsf+process.passHltDoubleEle33CaloIdLMWSeedLegL1match+process.passHltEle23Ele12CaloIdLTrackIdLIsoVLLeg1L1match)
